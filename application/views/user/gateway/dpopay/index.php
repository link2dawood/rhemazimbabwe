                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <div class="padd2 paddtzero">
                                <form action="<?php echo base_url(); ?>user/gateway/dpopay/dpo_pay" method="post">
                ...
                echo $fees_value['fee_type_code'];
                                    ...
                                    ?>
                                     <tr class="border_bottom">
                                        ...
                                        <tr class="bordertoplightgray">
                                            <td  bgcolor="#fff"><?php echo ('Credit Card Number') ?>:</td>
                                            <td  bgcolor="#fff" class="text-right"> <input type="text" class="form-control"  name="creditcardnumber" value="<?php //echo set_value('creditcardnumber', $params['creditcardnumber']); ?>" /><span class="alert-danger"><?php echo form_error('creditcardnumber');?></span></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td  bgcolor="#fff"><?php echo ('Credit Card Expiry'); ?>:</td>
                                            <td  bgcolor="#fff" class="text-right"> <input type="text" class="form-control" name="creditcardexpiry" value="<?php //echo set_value('creditcardexpiry', $params['creditcardexpiry']); ?>" placeholder="MMYY"><span class="alert-danger"><?php echo form_error('creditcardexpiry');?></span></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td  bgcolor="#fff"><?php echo ('Credit Card CVV'); ?>:</td>
                                            <td  bgcolor="#fff" class="text-right"> <input type="text" class="form-control" name="creditcardcvv" value="<?php //echo set_value('creditcardcvv', $params['creditcardcvv']); ?>" ><span class="alert-danger"><?php echo form_error('creditcardcvv');?></span></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td  bgcolor="#fff"><?php echo ('Card Holder Name'); ?>:</td>
                                            <td  bgcolor="#fff" class="text-right"> <input type="text" class="form-control" name="cardholdername" value="<?php //echo set_value('cardholdername', $params['cardholdername']); ?>" ><span class="alert-danger"><?php echo form_error('cardholdername');?></span></td>
                                        </tr>
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info"><?php echo ('pay_with_dpopay'); ?>  <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>

...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #fff; padding: 30px; border: 1px solid #ddd; border-top: none;">
        ...
        <p>Thank you for registering to become a partner with Rhema Zimbabwe through your student/staff portal! We are excited to have you join our community of supporters.</p>
        ...
        <ol style="padding-left: 20px;">
            ...
            <li style="margin-bottom: 10px;">
                <strong>Portal Access:</strong> You can view your partnership status and contributions through your student/staff portal.
            </li>
            <li style="margin-bottom: 10px;">
        ...
        <h3 style="color: #3c8dbc;">Access Your Partnership Dashboard</h3>
        <p>You can access your partnership dashboard anytime through your portal:</p>
        <div style="text-align: center; margin: 20px 0;">
            <a href="<?php echo $partner_data['base_url']; ?>user/partner" style="display: inline-block; background: #3c8dbc; color: #fff; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;">View My Partnership</a>
        </div>
        ...
        <ul style="list-style: none; padding: 0;">
            ...
            <li style="margin-bottom: 8px;">🌐 Website: <a href="<?php echo $partner_data['base_url']; ?>" style="color: #3c8dbc;"><?php echo $partner_data['base_url']; ?></a></li>
        </ul>

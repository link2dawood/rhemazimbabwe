...
<div id="myQuesImportModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <a class="btn btn-primary pull-right btn-xs mt5" data-toggle="tooltip" data-original-title="Download Sample CSV File"  href="<?php echo site_url('onlinecourse/courseexamquestion/exportformat'); ?>" target="_blank"><i class="fa fa-download"></i>  </a>

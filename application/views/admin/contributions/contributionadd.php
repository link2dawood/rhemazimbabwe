        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" id="contributionForm" method="post" action="<?php echo base_url('admin/partnercontributions/add'); ?>" enctype="multipart/form-data">
                        <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="partner_id" id="partner_id" required>
                                            ...
                                            <?php foreach ($partners as $partner) { ?>
                                                <option value="<?php echo $partner->id; ?>" <?php echo set_select('partner_id', $partner->id); ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="contribution_date" id="contribution_date" 
                                               value="<?php echo set_value('contribution_date', date('Y-m-d')); ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="amount" id="amount" 
                                                   value="<?php echo set_value('amount'); ?>" step="0.01" min="0" required>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="currency" id="currency">
                                            ...
                                            <option value="ZWL" <?php echo set_select('currency', 'ZWL'); ?>>ZWL</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="payment_method" id="payment_method" required>
                                            ...
                                            <option value="mobile_money" <?php echo set_select('payment_method', 'mobile_money'); ?>>Mobile Money</option>
                                            <option value="credit_card" <?php echo set_select('payment_method', 'credit_card'); ?>>Credit Card</option>
                                            <option value="debit_card" <?php echo set_select('payment_method', 'debit_card'); ?>>Debit Card</option>
                                            <option value="cheque" <?php echo set_select('payment_method', 'cheque'); ?>>Cheque</option>
                                            <option value="online" <?php echo set_select('payment_method', 'online'); ?>>Online</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            <option value="completed" <?php echo set_select('status', 'completed', true); ?>>Completed</option>
                                            ...
                                            <option value="failed" <?php echo set_select('status', 'failed'); ?>>Failed</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="transaction_id" id="transaction_id" 
                                               value="<?php echo set_value('transaction_id'); ?>" placeholder="Enter transaction ID">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference_no" id="reference_no" 
                                               value="<?php echo set_value('reference_no'); ?>" placeholder="Enter reference number">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="notes" id="notes" rows="3" 
                                                  placeholder="Enter any additional notes"><?php echo set_value('notes'); ?></textarea>
                                    </div>
                                </div>
                            </div>

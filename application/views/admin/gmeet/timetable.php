...
if ($gmeet_value->status == 0) {
            ?>
<a data-placement="top" href="<?php echo base_url();?>admin/gmeet/start/<?php echo $gmeet_value->id."/class"; ?>" class="btn label-success btn-xs start-mr-20"  target="_blank">
...
if ($gmeet_value->created_id == $logged_staff_id) {
            if ($this->rbac->hasPrivilege('gmeet_live_classes', 'can_delete')) {
                ?>
                                                        <a data-placement="top" href="<?php echo base_url(); ?>admin/gmeet/delete/<?php echo $gmeet_value->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">

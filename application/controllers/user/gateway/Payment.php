        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            if (!empty($row_counter)) {
                ...
                $gateway_processing_charge=0;
                    ...
                    $gateway_processing_charge=(($total_amount_balance * $pay_method->charge_value)/100);
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            if ($this->input->post('submit_mode') == "offline_payment") {
                ...
                if (!empty($this->payment_method)) {
                    ...
                    // $fee_record['applied_fee_discount'] = $applied_fee_discount;
                    
                    // multiple discount applied section
                    
                    $final_discount_amount = 0; //addedd
                    $per_amount = 0; //addedd
                    ...
                    $params              = array(
                       ...
                       // 'applied_fee_discount'      => ($applied_fee_discount),

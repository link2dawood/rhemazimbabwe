...
class Dpopay extends Studentgateway_Controller {
    ...
    public function dpo_pay() {
        ...
        if ($this->form_validation->run() == false) {
			...
			curl_setopt($ch, CURLOPT_POSTFIELDS, "<?xml version='1.0' encoding='utf-8'?><API3G><CompanyToken>8E0F3AD8-B254-419A-80DF-6D9C280A5130</CompanyToken><Request>createToken</Request><Transaction><PaymentAmount>1</PaymentAmount><PaymentCurrency>USD</PaymentCurrency><CompanyRef>gff</CompanyRef><RedirectURL>".base_url('user/gateway/success')."</RedirectURL><BackURL>".base_url('user/gateway/dpo_pay')."</BackURL><CompanyRefUnique>0</CompanyRefUnique><PTL>5</PTL></Transaction><Services><Service><ServiceType>86280</ServiceType><ServiceDescription>Flight from Nairobi to Diani</ServiceDescription><ServiceDate>2025/12/20 19:00</ServiceDate></Service></Services></API3G>");
			$headers = array();
            ...
            if ($json['ResultExplanation'] == 'Transaction Charged') {

        ...
        if ($this->form_validation->run() == false) {           
            ...
            if ($lesson_type == "text" || $lesson_type == "pdf" || $lesson_type == "document") {  
                if (!empty($_FILES['lesson_attachment']['name'])) {          
                    $dir_path     = 'uploads/course_content/' . $section_id . '/' . $insert_id.'/';
                    $thumb_path   = 'uploads/course_content/' . $section_id . '/' . $insert_id.'/thumb_path/';
                    ...
                    foreach ($responses['images'] as $key => $value) {
                        $upload_attachment_data = array('lesson_id' => $insert_id, 'attachment' => $value['store_name'],'attachment_name'=>$value['name']);

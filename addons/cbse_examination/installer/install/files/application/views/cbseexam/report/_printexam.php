...
?>
        <div class="btn-group pb10" role="group" aria-label="First group">
            <button type="button" class="btn btn-default btn-xs" onclick="printDiv('headerTable')"><i class="fa fa-print"></i></button>
            <button type="button" class="btn btn-default btn-xs" onclick="fnExcelReport()"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button>
        </div>
                            ...
                            <tr>
                                ...
                                ?>
                                        <td class="text-center">
                                            ...
                                            $assessment_exists =  find_subject_assessment_exists($exam_subject_assessments, $subject_value->id, $exam_assessment_value->id);

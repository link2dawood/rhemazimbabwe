                ...
                <div class="invoice">         
                    ...
                    <?php
                            ...
                            foreach ($feearray as $fee_key => $feeList) {
								...
								<table width="100%" cellpadding="0" cellspacing="0">		
									<tbody>
										<tr><td class="title-around-span"><span><?php echo $this->lang->line('fees'); ?></span></td></tr>
									</body>
								</table>
							...
							<?php } } } } ?> 
								...
								<br> 
								<table width="100%" cellpadding="0" cellspacing="0" style="line-height: 11px;">	
									<tr><td class="title-around-span" colspan="5"><span><?php echo $this->lang->line('grand_total'); ?></span></td></tr>
									<tbody>
										<tr> 
											<th width="25%" class="text text-left"><?php echo $this->lang->line('total'); ?>(<?php echo $currency_symbol;?>)</th>
											<th width="20%" style="text-align:center"><?php echo $this->lang->line('discount'); ?>(<?php echo $currency_symbol;?>)</th>	
											<th width="20%" style="text-align:center"><?php echo $this->lang->line('fine'); ?>(<?php echo $currency_symbol;?>)</th>
											<th width="20%" style="text-align:center"><?php echo $this->lang->line('paid'); ?>(<?php echo $currency_symbol;?>)</th>
											<th width="15%" style="text-align:right"><?php echo $this->lang->line('balance'); ?>(<?php echo $currency_symbol;?>)</th>											
										</tr>
										<tr>
                                            <td class="text text-left"><?php echo amountFormat($total_amount); ?></td>
											<td class="text text-center"><?php echo amountFormat($total_discount_amount); ?></td>
											<td class="text text-center"><?php echo amountFormat($total_fine_amount); ?></td>
											<td class="text text-center"><?php echo amountFormat($total_deposite_amount); ?></td>										
											<td class="text text-right"><?php echo amountFormat($total_balance_amount); ?></td>											
										</tr>

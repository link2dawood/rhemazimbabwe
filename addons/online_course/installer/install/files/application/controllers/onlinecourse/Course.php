...
class Course extends Admin_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('course_model', 'coursesection_model', 'courselesson_model', 'studentcourse_model', 'coursequiz_model', 'course_payment_model', 'courseofflinepayment_model', 'coursereport_model', 'coursecategory_model','coursetag_model'));
    ...
    public function getcourselist(){
        ...
        if (!empty($m->data)) {
            foreach ($m->data as $key => $value) {
                ...
                $course_detail = '';
                if ($this->rbac->hasPrivilege('online_course', 'can_view')) {
                    $course_detail = "<a href='#' onclick='loadcoursedetail(" . '"' . $value->id . '"' . "  )' class='btn btn-default btn-xs btn-add ' data-id=" . $value->id . " data-backdrop='static' data-keyboard='false' data-placement='top' data-toggle='modal' data-target='#course_detail_modal' title=" . $this->lang->line('manage_course') . "><i class='fa fa-reorder'></i></a> &nbsp &nbsp";
                }

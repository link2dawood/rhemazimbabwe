                              ...
                              <form action="<?php echo base_url(); ?>students/online_course/payfast/guestpay" method="post">
                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                  ...
                                  <?php } ?> 
                                    ...
                                    <tr class="paybtngray">
                                        <td>
                                            <button type="button" onclick="window.history.go(-1); return false;" name="search"  value="" class="btn btn-info buttongray"><i class="fa fa-chevron-left valign-middle"></i> <?php echo $this->lang->line('back'); ?> </button>
                                        </td>
                                        <td class="text-right">

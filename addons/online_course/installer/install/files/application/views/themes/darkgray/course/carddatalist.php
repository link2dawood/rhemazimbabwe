...
<li class="dropdown" id="card_data">
    ...
    <div class="dropdown-menu shop-chart-top13">
                    ...
                    <div class="cartitem">
                        ...
                        <div class="cartdetail">
                            <a href="<?php echo base_url() . $course_data["url"] ?>">
                                ...
                                <div class="courseprice"><?php echo $currency_symbol.amountFormat($cvalue['price']); ?></div>
                            </a>
        ...
        <div class="cart-footer" style="border:solid thin blue">
            <div class="focarttotal-price"><?php echo $this->lang->line('total') . " " . $currency_symbol.amountFormat($total) ; ?>

                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('expense_report'); ?></h3>
                        </div>
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('expense_report');
                                                $this->customlib->get_postmessage();
                                                ?></div>
                            
                                 <table class="table table-striped table-bordered table-hover expense-list" data-export-title="<?php echo $this->lang->line('expense_report'); $this->customlib->get_postmessage();   ?>">
                                        <thead>
                                            <tr>
...
$(document).ready(function() {
     initDatatable('expense-list','admin/multibranch/finance/getexpenselistbydate',[],[],100);
           ...
           data: form_data, // serializes the form's elements.
              ...
              success: function(response) { // your success handler
                ...
                if(!response.status){
                   ...
                   initDatatable('expense-list','admin/multibranch/finance/getexpenselistbydate',response.params,[],100);
                }
              },
